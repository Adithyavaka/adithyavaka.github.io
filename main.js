...
module.exports = "<div class=\"menu\">\n  <!-- --------this is the Sidenav--------- -->\n  <mat-drawer-container class=\"example-container\" autosize>\n  <mat-drawer #sidenav class=\"example-sidenav\" mode=\"\">\n   <div class=\"sidenav1\">\n    <div class=\"details\">\n        <h3>Adithya vaka</h3>   \n        <p>Developer, Designer, Programmer</p>\n    </div>\n      \n    \n          <a [routerLink]=\"['/profile']\" (click)=\"sidenav.close()\" routerLinkActive=\"router-link-active\" ><i class=\"material-icons icons\">home</i>&nbsp;Home</a>\n      \n          <a [routerLink]=\"['/skills']\" (click)=\"sidenav.close()\" routerLinkActive=\"router-link-active\"><i class=\"material-icons icons\">grade</i>&nbsp;Skill</a>\n          <a [routerLink]=\"['/experience']\"  (click)=\"sidenav.close()\"routerLinkActive=\"router-link-active\"><i class=\"material-icons icons\">work</i>&nbsp;Experience</a>\n          <a [routerLink]=\"['/portfolio']\"  (click)=\"sidenav.close()\"routerLinkActive=\"router-link-active\"><i class=\"material-icons icons\">developer_board</i>&nbsp;Portfolio</a>\n\n          <a [routerLink]=\"['/contact']\"  (click)=\"sidenav.close()\"routerLinkActive=\"router-link-active\"><i class=\"material-icons icons\">email</i>&nbsp;Contant</a>\n   </div>\n  </mat-drawer>\n\n     \n    <div class=\"menu-icon\">\n          <i class=\"material-icons\"matTooltip=\"Info about the action\" (click)=\"sidenav.toggle()\">menu</i>\n    </div>\n  \n    <router-outlet></router-outlet>\n</mat-drawer-container>\n<!-- -------------------- -->\n</div>\n"
